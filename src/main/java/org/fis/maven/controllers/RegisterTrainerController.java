...
public class RegisterTrainerController {
    ...
    @FXML
    public void handleRegisterTrainer() throws Exception {
        try {
            UserService.addUser(usernameField, passwordField, role, name.getText(), eMail.getText(), phoneNumber.getText());
            Parent root= FXMLLoader.load(getClass().getClassLoader().getResource("trainerPage.fxml"));
